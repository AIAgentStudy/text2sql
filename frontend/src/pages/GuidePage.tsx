...
function TableDef({
  ...
  return (
    <div className="mb-3 last:mb-0">
      <p className="font-mono text-purple-700 text-sm font-semibold">{name}</p>
      ...
      <main className="flex-1 overflow-y-auto bg-white">
        <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
          ...
          <section>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-5 text-base text-gray-700 leading-relaxed space-y-2">
              <p>
                <strong className="text-gray-900">Text2SQL Agent</strong>는
                자연어 질문을 SQL로 자동 변환하여 데이터베이스에서 결과를
                조회하는 AI 에이전트입니다.
              </p>
              <p>
                한국어로 질문하면 LLM이 SQL 쿼리를 생성하고, 3단계
                검증(키워드·스키마·시맨틱)을 거쳐 안전하게 실행합니다. SELECT
                쿼리만 허용되며, 데이터 변경은 불가합니다.
              </p>
              <p>
                결과는 테이블과 차트(막대·선·파이)로 자동 시각화되며, 대화
                맥락을 유지하여 후속 질문도 가능합니다.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {[
                ...
                <div
                  key={item.label}
                  className="bg-white border border-gray-200 rounded-2xl shadow-sm p-4 text-center"
                >
          ...
          <section>
            ...
            <p className="text-base text-gray-700 mb-4">
              총 21개 테이블이 5개 도메인으로 구성됩니다. 접근 가능한 테이블은
              역할에 따라 다릅니다.
            </p>
          ...
          {/* 4. 질문 예시 */}
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">질문 예시</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                {
                  category: "매출 분석",
                  query: "이번 달 지역별 매출 합계를 알려줘",
                },
                {
                  category: "고객 분석",
                  query: "주문 금액이 가장 높은 고객사 5곳은?",
                },
                {
                  category: "주문 추이",
                  query: "최근 3개월간 월별 주문 건수 추이를 보여줘",
                },
                {
                  category: "재고 현황",
                  query: "재고 수량이 10개 이하인 상품 목록",
                },
                {
                  category: "배송 성과",
                  query: "운송사별 평균 배송 소요시간은?",
                },
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-4">
                <p className="text-base font-bold text-red-600 mb-2">Admin</p>
          ...
          <section className="pb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3">사용 팁</h2>
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-5 space-y-4 text-base text-gray-700">
              <div>
                <p className="font-semibold text-blue-700 text-base">
                  1. 구체적으로 질문하세요
                </p>
                <p className="text-sm text-gray-600 mt-1">
                  &ldquo;매출 보여줘&rdquo; 보다 &ldquo;2024년 1월 서울 지역
                  매출 합계&rdquo;처럼 기간, 지역, 조건을 명시하면 정확한 결과를
                  얻을 수 있습니다.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  생성된 SQL 쿼리가 표시되면 확인 후 실행됩니다. 의도와 다른
                  쿼리는 실행하지 말고 다시 쿼리를 요청해주세요.
                </p>
              </div>
              <div>
